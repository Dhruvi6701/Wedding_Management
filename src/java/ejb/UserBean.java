...
public class UserBean implements UserBeanLocal {
    ...
    @PersistenceContext(unitName = "PersistennceUnit")
    EntityManager em;
    HashUtility haspass;
    @PostConstruct
    public void init() {
...
//           {
            ...
            user.setUserPassword(haspass.getHashPassword(user_password));
            user.setRoleId(r);
...
//                 String passtohash=haspass.getHashPassword(user_pass.toString());
